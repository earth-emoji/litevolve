...
class World(models.Model):
    ...
    creator = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name='worlds')
...
class Rule(models.Model):
    ...
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='rules', blank=True)
    creator = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name='rules', blank=True)
...
class CelestialBody(models.Model):
    ...
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='celestial_bodies', blank=True)
    creator = models.ForeignKey(
...
class NaturalPhenomena(models.Model):
    ...
    description = HTMLField(null=True, blank=True)
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='natural_phenomenas', blank=True)
    creator = models.ForeignKey(
...
class Season(models.Model):
    ...
    description = HTMLField(null=True, blank=True)
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='seasons', blank=True)
    creator = models.ForeignKey(
...
class Place(models.Model):
    ...
    description = HTMLField(null=True, blank=True)
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='places', blank=True)
    creator = models.ForeignKey(
        UserProfile, on_delete=models.CASCADE, related_name='places', blank=True)
    seasons = models.ManyToManyField(
        Season, related_name='seasons', through='PlaceSeason', blank=True)
...
class PlaceSeason(models.Model):
    ...
    season = models.ForeignKey(
        Season, on_delete=models.CASCADE, related_name='places')
...
class NaturalObject(models.Model):
    ...
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='natural_objects', blank=True)
    creator = models.ForeignKey(
...
class Species(models.Model):
    ...
    world = models.ForeignKey(
        World, on_delete=models.CASCADE, related_name='species', blank=True)
    creator = models.ForeignKey(
